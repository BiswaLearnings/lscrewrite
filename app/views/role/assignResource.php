...
<script src="<?php echo WEB_PATH.'/content/Tabs/jquery-ui.js'?>"></script>
    <div id="pane">
        <div id="submenus">
            <div class="submenu"><img src="<?php echo WEB_PATH; ?>/content/images/commonimages/back.png" height="13" width="13" style="border: none; padding-right: 5px;"/><a href="<?php echo sprintf('?load=roles/roleList/%s', $data["roleID"]) ?>"><?php echo $lang['back_to'].$lang['roles'];?></a></div> 
            <div class="submenu active"><img src="<?php echo WEB_PATH; ?>/content/images/commonimages/view.png" height="13" width="13" style="border: none; padding-right: 5px;"/><a href="#"><?php echo $lang['assigndeassignresource'];?></a></div>
        </div>
        ...
        <div class="bigContainer">
            <strong><?php echo $lang['assigndeassignresource'];?></strong><hr/>
            <?php
