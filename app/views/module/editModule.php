...
?>
<script src="<?php echo WEB_PATH; ?>content/js/jquery-1.9.1.min.js" type="text/javascript" ></script>
...
<div id="pane">
    ...
    <div class="bigContainer">
        <strong><?php echo $lang['edit_module'];?></strong><hr/>
        <?php
        include_once __SITE_PATH . '/templates/module/edit_module_form.php';
        ?>
	</div>
    <br />
</div>
