...
?>
    ...
    <div id="pane">
        <div id="submenus">
        <div class="submenu active"><img src="<?php echo WEB_PATH; ?>/content/images/commonimages/create.png" height="10" width="10" style="border: none; padding-right: 5px;"/><a href="?load=resource/addResource"><?php echo $lang['add_new_resource'];?></a></div>
        ...
        <div class="bigContainer">
            <strong><?php echo $lang['add_new_resource'];?></strong><hr/>
            <?php
            include_once __SITE_PATH.'/templates/user/add_resource_form.php';
            ?>
        </div>
      <?php
