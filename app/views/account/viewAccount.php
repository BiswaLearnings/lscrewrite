...
<div id="pane">
    ...
    <hr/>
 	<div class="bigContainer">
        <strong>
        	<?php 
	        echo sprintf("<img id='accountLogo' width='15px' height='15px' style='border: none; padding-right: 5px; padding-top: 5px;' src='data:image/jpeg;base64,%s' />", base64_encode($accountDetails["accountlogo"]));
	        echo $accountDetails["accountname"];
	        ?>
        </strong><hr/>
    <?php
		//TO DO
        include_once __SITE_PATH.'/templates/account/view_account_form.php';
	?>
