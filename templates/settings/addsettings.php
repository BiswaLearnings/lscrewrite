...
<?php
		      require_once __SITE_PATH . '/libs/form_handler.php';
                ...
                $form -> addLabel (' ',  '');
                $form->addButton('submit', array('name' => 'save', 'value' => 'save', 'style' => 'background:#0066A2;color:white;border-style:outset;border-color:#0066A2;height:30px;width:100px;font: bold 15px arial,sans-serif;'));
                $form->closeForm();
                echo $form;
